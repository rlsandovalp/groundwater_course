...
plc = mt.createCube(size=[40, 1, 15], marker=1, boundaryMarker=0)
cube = mt.createCube(size=[15, 1, 8], marker=2, boundaryMarker=0)
geom = plc + cube
...
### Visualize
ax, _ = pg.show(mesh, alpha=0.3, hold=True, colorBar=False, markers = True, showMesh=True)
...
drawMesh(ax, mesh, style = 'wireframe')
ax.show()
